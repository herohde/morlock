...
import (
	...
	"github.com/herohde/morlock/pkg/sargon"
...
chess engine, described in the book "Sargon". The re-implementation uses
the UCI protocol for use in modern chess programs.
Options:
`)
		flag.PrintDefaults()
	}
